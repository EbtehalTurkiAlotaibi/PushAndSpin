...
<graphml xmlns="http://graphml.graphdrawing.org/xmlns" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://graphml.graphdrawing.org/xmlns http://graphml.graphdrawing.org/xmlns/1.0/graphml.xsd">
  ...
  <key id="key1" for="edge" attr.name="Weight" attr.type="double"> <!-- Unit edge weights by default -->
    <default>1.0</default>
  </key>
  <graph id="G" edgedefault="undirected" parse.nodeids="free" parse.edgeids="canonical" parse.order="nodesfirst">
    ...
    <node id="n3">
      <data key="key0">3.0 1.0 0.0</data>
    </node>
    <node id="n4">
      <data key="key0">5.0 1.0 0.0</data>
    </node>
    <node id="n5">
      <data key="key0">3.0 2.0 0.0</data>
    </node>
    <node id="n6">
      <data key="key0">4.0 2.0 0.0</data>
    </node>
    <node id="n7">
      <data key="key0">5.0 2.0 0.0</data>
    </node>
    <node id="n8">
      <data key="key0">2.0 3.0 0.0</data>
    </node>
    <node id="n9">
      <data key="key0">3.0 3.0 0.0</data>
    </node>
    <node id="n10">
      <data key="key0">0.0 4.0 0.0</data>
    </node>
    <node id="n11">
      <data key="key0">1.0 4.0 0.0</data>
    </node>
    <node id="n12">
      <data key="key0">2.0 4.0 0.0</data>
    </node>
    <node id="n13">
      <data key="key0">0.0 5.0 0.0</data>
    </node>
    <node id="n14">
      <data key="key0">2.0 5.0 0.0</data>
    </node>
    <node id="n15">
      <data key="key0">0.0 6.0 0.0</data>
    </node>
    <node id="n16">
      <data key="key0">1.0 6.0 0.0</data>
    </node>
    <node id="n17">
      <data key="key0">2.0 6.0 0.0</data>
    </node>
